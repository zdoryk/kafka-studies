...
> hello world!
# [2024-05-04 19:57:37,997] WARN [Producer clientId=console-producer] Error while fetching metadata with correlation id
# 5 : {new_topic=UNKNOWN_TOPIC_OR_PARTITION} (org.apache.kafka.clients.NetworkClient)
# Note: The above will create a topic which did not exist before
